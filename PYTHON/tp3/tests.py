...
class TestHTMLFiles(TestBase):
    ...
    def test_not_found_status(self):
        ...
        try:
            urllib.request.urlopen(self.url + 'public/no-file.html')
...
class TestJPEGFiles(TestBase):
    ...
    def test_jpeg_content_type(self):
        ...
        res = urllib.request.urlopen(self.url + 'public/images.jpg')
        headers = dict(res.info())
        self.assertIn('jpg', headers['Content-Type'])
    ...
    def test_jpeg_not_found(self):
        ...
        self.assertRaises(
            ...
            urllib.request.urlopen, self.url + 'public/non-image.jpg'
        )
...
class TestPNGFiles(TestBase):
    ...
    def test_png_content_type(self):
        """Server should return content-type."""
        res = urllib.request.urlopen(self.url + 'public/images.png')
        headers = dict(res.info())
        self.assertIn('png', headers['Content-Type'])
    ...
    def test_png_not_found(self):
        ...
        self.assertRaises(
            urllib.error.HTTPError,
            urllib.request.urlopen, self.url + 'public/non-image.png'
        )
...
class TestMP3Files(TestBase):
    ...
    def test_mp3_content_type(self):
        """Server should return content-type."""
        res = urllib.request.urlopen(self.url + 'public/audio.mp3')
        headers = dict(res.info())
        self.assertIn('mp3', headers['Content-Type'])
    ...
    def test_mp3_not_found(self):
        ...
        self.assertRaises(
            urllib.error.HTTPError,
            urllib.request.urlopen, self.url + 'public/non-audio.mp3'
        )
...
class TestMP4Files(TestBase):
    ...
    def test_mp4_content_type(self):
        """Server should return content-type."""
        res = urllib.request.urlopen(self.url + 'public/video.mp4')
        headers = dict(res.info())
        self.assertIn('mp4', headers['Content-Type'])
    ...
    def test_mp4_not_found(self):
        ...
        self.assertRaises(
            urllib.error.HTTPError,
            urllib.request.urlopen, self.url + 'public/non-video.mp4'
        )
...
class TestFormRequests(TestBase):
    ...
    def test_form_content(self):
        ...
        self.assertNotEqual(len(json_res), 0)
    ...
    def test_form_wrong_content_type(self):  # FAILED********************************************************
...
class TestJsonRequests(TestBase):
    ...
    def test_json_invalid_json(self):# FAILED********************************************************
